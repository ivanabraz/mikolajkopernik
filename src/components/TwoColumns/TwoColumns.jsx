...
const TwoColumns = (TwoColumnsProps) => {
    ...
    return (
        ...
        className=" w-full h-full grid gap-0 grid-cols-1 xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
            <div className={`${TwoColumnsProps.divOrder} w-full h-full flex flex-col justify-center m-auto my-5
            ...
            text-sm xs:text-sm sm:text-sm md:text-lg lg:text-lg`}>
                ...
                <p className="first-letter:text-9xl first-letter:font-goudy first-letter:mr-3 first-letter:mt-[-7px] first-letter:text-nblue first-letter:float-left">
                    {TwoColumnsProps.text}
                </p>
            </div>
            {/* IMAGE */}
            <div className='w-full h-full p-14 flex flex-col justify-center m-auto'>
                <motion.img
                ...
                alt={TwoColumnsProps.imgAlt} className="w-auto h-full" src={TwoColumnsProps.imgSrc}
                />
            </div>
        </div>                
    )
